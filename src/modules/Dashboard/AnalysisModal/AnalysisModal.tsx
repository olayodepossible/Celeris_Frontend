...
import { analysisformInputs } from "../DashboardImports";
import Loader from "../../../shared/Loader/Loader";
import { CelerisBtn } from "../../../shared/Button";
import Form from "../../../shared/Forms/Form";

Modal.setAppElement("#root");
const AnalysisModal = ({ isModalOpen }: { isModalOpen: boolean }) => {
  ...
  return (
    <>
      <Modal
        isOpen={modalOpen === false ? false : isModalOpen}
        ...
        {isFormState === 1 ? (
          ...
          <div className="successModal d-flex flex-column align-items-center justify-content-center w-100">
            <div className="d-flex flex-column align-items-center justify-content-center">
              ...
              <CelerisBtn variant="primary" onClick={() => setModalOpen(false)}>
                View analysis
              </CelerisBtn>
            </div>
          </div>
